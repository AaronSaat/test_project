...
<p>
    ...
    <?= Html::a("Hanya Duplicate ({$duplicateCountJournalError})", ['journal-errors', 'filter' => 'duplicate'], ['class' => 'btn btn-info', 'style' => 'color: white;']) ?>
</p>
    ...
    'columns' => [
        ...
        [
            ...
            'contentOptions' => function ($model) {
                ...
                } elseif ($model['info'] === 'duplicate') {
                    return ['style' => 'background-color: #00FFFF; color: white;'];
                }
                return [];
            },
        ],
